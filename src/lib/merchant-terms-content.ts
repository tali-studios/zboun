...
export const MERCHANT_TERMS_SECTIONS: MerchantTermsSection[] = [
  ...
  {
    number: 3,
    title: "Account Security and Authorised Users",
    clauses: [
      ...
      "You must provide accurate, complete, and current registration and contact information and update it promptly.",
      ...
      "Operator may suspend or restrict access where we reasonably suspect unauthorised use, abuse, legal risk, non-payment, or breach of these Terms.",
    ],
  },
  {
    number: 4,
  ...
  },
  {
    ...
    clauses: [
      ...
      "You shall not use the Platform to harass customers or third parties, spam messaging channels, scrape data unlawfully, reverse engineer the Platform except as permitted by mandatory law, or interfere with Platform security or availability.",
  ...
  },
  {
    ...
    clauses: [
      "Operator may, at its sole reasonable discretion: remove or hide Merchant Content; suspend marketplace listing; suspend ordering features; suspend or terminate your account; and/or report content or conduct to competent authorities.",
