-- Zboun - Run this in Supabase SQL Editor
-- This file contains:
-- 1) Full schema (tables + RLS + policies)
-- 2) Superadmin role mapping for tali-studios@outlook.com
-- 3) Verification queries
--
-- IMPORTANT:
-- Before running the superadmin INSERT section, create this user in:
-- Supabase Dashboard -> Authentication -> Users
-- Email: tali-studios@outlook.com
...
select
  ...
  null
from auth.users au
where au.email = 'tali-studios@outlook.com'
...
from auth.users
where email = 'tali-studios@outlook.com';
